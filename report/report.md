...
consistent across folds. The tuned **{{A_BEST}}** reached **{{A_ACC}}**
test accuracy, **{{A_F1}}** macro-F1 and **{{A_AUC}}** one-vs-rest macro
...
| Model | R² | RMSE | MAE |
|---|---|---|---|
| Linear regression | {{B_LIN_R2}} | {{B_LIN_RMSE}} | {{B_LIN_MAE}} |
| Best ({{B_BEST}}) | {{B_BEST_R2}} | {{B_BEST_RMSE}} | {{B_BEST_MAE}} |
